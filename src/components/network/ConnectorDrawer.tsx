        ...
        <div>
          ...
          <ConnectorMenu>
            <li>
              <span
                className={
                  location.pathname === `/connector/${id}` ? "active" : ""
                }
                onClick={() => {
                  naigate(`/connector/${id}`);
                }}
              >
                Connector Overview
              </span>
            ...
            <li>
              <span
                className={
                  location.pathname === `/connector/${id}/settings`
                    ? "active"
                    : ""
                }
                onClick={() => {
                  naigate(`/connector/${id}/settings`);
                }}
              >
                Settings
              </span>
                      ...
                      <span
                        className={
                          location.pathname.includes(
                            `/connector/${id}/triggers/${trigger.key}/`
                          )
                            ? "active"
                            : ""
                        }
                        onClick={() => {
                          naigate(
                            `/connector/${id}/triggers/${trigger.key}/settings`
                          );
                        }}
                      >
                        <Icon>
            ...
            <li>
              <span
                className={
                  location.pathname === `/connector/${id}/actions`
                    ? "active"
                    : ""
                }
                onClick={() => {
                  naigate(`/connector/${id}/actions`);
                }}
              >
                Actions
              </span>
                  ...
                  {[
                    ...
                    <li key={action.key}>
                      <span
                        className={
                          location.pathname.includes(
                            `/connector/${id}/actions/${action.key}/`
                          )
                            ? "active"
                            : ""
                        }
                        onClick={() => {
                          naigate(
                            `/connector/${id}/actions/${action.key}/settings`
                          );
                        }}
                      >
                        <Icon>
            ...
            <li>
              <span
                className={
                  location.pathname === `/connector/${id}/advanced`
                    ? "active"
                    : ""
                }
                onClick={() => {
                  naigate(`/connector/${id}/advanced`);
                }}
              >
                Source Code
              </span>
